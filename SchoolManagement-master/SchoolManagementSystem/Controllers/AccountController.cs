...
namespace SchoolManagementSystem.Controllers
{
    public class AccountController : Controller
    {
        ...
        public string Setup()
        {
            ...
            repository.AddStudent(new Student { PIN = "2010", FirstName = "Adam", LastName = "Sandler", Password = "123", Class_Id = 1, PhoneNumber = "0792893345", StreetAddress = "Chisniau, str Mircea cel Baatrin 3, ap 104"});
            repository.AddStudent(new Student { PIN = "2011", FirstName = "Jim",  LastName = "Carrey", Password = "123", Class_Id = 1, PhoneNumber = "0792893345", StreetAddress = "Chisniau, str Mircea cel Baatrin 3, ap 104" });
            repository.AddStudent(new Student { PIN = "2012", FirstName = "Anne", LastName = "Hathaway", Password = "123", Class_Id = 1, PhoneNumber = "0792893345", StreetAddress = "Chisniau, str Mircea cel Baatrin 3, ap 104" });
            repository.AddStudent(new Student { PIN = "2013", FirstName = "Robert", LastName = "John Downey", Password = "123", Class_Id = 2, PhoneNumber = "0792893345", StreetAddress = "Chisniau, str Mircea cel Baatrin 3, ap 104" });
            repository.AddStudent(new Student { PIN = "2014", FirstName = "Chris", LastName = "Evans", Password = "123", Class_Id = 3, PhoneNumber = "0792893345", StreetAddress = "Chisniau, str Mircea cel Baatrin 3, ap 104" });
            repository.AddStudent(new Student { PIN = "2015", FirstName = "Chris", LastName = "Hemsworth", Password = "123", Class_Id = 4, PhoneNumber = "0792893345", StreetAddress = "Chisniau, str Mircea cel Baatrin 3, ap 104" });
